...
class CRouter {
	...
	private array $routes = [
		...
		'export.regexes'							=> [CControllerExport::class,										'layout.export',		null],
		...
		'host.list.data'                            => [CControllerHostListData::class,								    'layout.json',		    null],
		...
		'latest.view.data'							=> [CControllerLatestViewData::class,								'layout.json',			null],
		'lldrule.list'								=> [CControllerLldRuleList::class,									'layout.htmlpage',		'lldrule.list'],
		'lldrule.create'							=> [CControllerLldRuleCreate::class,								'layout.json',			null],
		'lldrule.delete'							=> [CControllerLldRuleDelete::class,								'layout.json',			null],
		'lldrule.disable'							=> [CControllerLldRuleDisable::class,								'layout.json',			null],
		'lldrule.edit'								=> [CControllerLldRuleEdit::class,									'layout.json',			'lldrule.edit'],
		'lldrule.enable'							=> [CControllerLldRuleEnable::class,								'layout.json',			null],
		'lldrule.update'							=> [CControllerLldRuleUpdate::class,								'layout.json',			null],
		'lldrule.prototype.list'					=> [CControllerLldRulePrototypeList::class,							'layout.htmlpage',		'lldrule.prototype.list'],
		'lldrule.prototype.create'					=> [CControllerLldRulePrototypeCreate::class, 						'layout.json',			null],
		'lldrule.prototype.delete'					=> [CControllerLldRulePrototypeDelete::class,						'layout.json',			null],
		'lldrule.prototype.disable'					=> [CControllerLldRulePrototypeDisable::class,						'layout.json',			null],
		'lldrule.prototype.edit'					=> [CControllerLldRulePrototypeEdit::class,							'layout.json',			'lldrule.prototype.edit'],
		'lldrule.prototype.enable'					=> [CControllerLldRulePrototypeEnable::class,						'layout.json',			null],
		'lldrule.prototype.update'					=> [CControllerLldRulePrototypeUpdate::class,						'layout.json',			null],
		'lldrule.prototype.updatediscover'			=> [CControllerLldRulePrototypeUpdateDiscover::class,				'layout.json',			null],
		...
		'topology.view'							=> [CControllerTopologyView::class,									'layout.htmlpage',		'monitoring.topology.view'],
		'topology.devices.get'					=> [CControllerTopologyDevicesGet::class,							'layout.json',			null],
		'topology.neighbors.get'					=> [CControllerTopologyNeighborsGet::class,							'layout.json',			null],
		'topology.ports.get'						=> [CControllerTopologyPortsGet::class,								'layout.json',			null],
		'topology.ports.link'						=> [CControllerTopologyPortsLink::class,							'layout.json',			null],
		'topology.ports.unlink'					=> [CControllerTopologyPortsUnlink::class,							'layout.json',			null],
		'topology.problems.get'					=> [CControllerTopologyProblemsGet::class,							'layout.json',			null],
		...
		'topology.hosts.search'				=> [CControllerTopologyHostsSearch::class,						'layout.json',			null],
		...
		'problem.view.data'							=> [CControllerProblemViewData::class,								'layout.json',			null],
		...
		'template.list.data'                        => [CControllerTemplateListData::class,								'layout.json',		    null],
		...
		'user.device.init.view'						=> [CControllerUserDeviceInitView::class,							'layout.json',			'user.device.init.view'],
		...
		'userprofile.device.list'					=> [CControllerUserProfileDeviceList::class,						'layout.htmlpage',		'userprofile.device.list'],
		...
		'validate.use'								=> [CControllerValidateUse::class,									'layout.json',			null],
