...
class CRouter {
	...
	private array $routes = [
		...
		'popup.scheduledreport.subscription.check'	=> [CControllerPopupScheduledReportSubscriptionCheck::class,		'layout.json',			null],
		...
		'popup.triggerexpr.edit'					=> [CControllerPopupTriggerExprEdit::class, 						'layout.json',			'popup.triggerexpr'],
		'popup.triggerexpr.check'					=> [CControllerPopupTriggerExprCheck::class, 						'layout.json',			null],
		...
		'scheduledreport.create'					=> [CControllerScheduledReportCreate::class,						'layout.json',			null],
		'scheduledreport.delete'					=> [CControllerScheduledReportDelete::class,						'layout.json',			null],
		...
		'usergroup.create'							=> [CControllerUsergroupCreate::class, 								'layout.json',			null],
		...
		'userrole.create'							=> [CControllerUserroleCreate::class, 								'layout.json',			null],
		...
		'userrole.update'							=> [CControllerUserroleUpdate::class, 								'layout.json',			null],
