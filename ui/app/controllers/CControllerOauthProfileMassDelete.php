...
class CControllerOauthProfileMassDelete extends CController {
	...
	protected function doAction(): void {
		...
		DB::delete('oauth_profile', ['oauthprofileid' => $ids]);

		$output['success'] = [
			'title' => _n('OAuth profile deleted', 'OAuth profiles deleted', $count),
			'action' => 'delete'
		];
