...
class CControllerTopologyProblemsGet extends CController {
	...
	protected function doAction(): void { $this->setResponse(new CControllerResponseData(['main_block' => json_encode(['problems' => CTopologyPrototype::getProblems($this->getInput('id'))])])); }
}
